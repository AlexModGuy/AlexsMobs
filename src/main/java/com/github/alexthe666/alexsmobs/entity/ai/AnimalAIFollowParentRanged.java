...
public class AnimalAIFollowParentRanged  extends Goal {
    ...
    public boolean canUse() {
        if (this.childAnimal.getAge() >= 0) {
            ...
            List<Animal> lvt_1_1_ = this.childAnimal.level.getEntitiesOfClass(this.childAnimal.getClass(), this.childAnimal.getBoundingBox().inflate(range, range * 0.5D, range));
