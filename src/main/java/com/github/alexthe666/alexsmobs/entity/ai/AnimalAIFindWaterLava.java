...
public class AnimalAIFindWaterLava extends Goal {
    ...
    public boolean shouldContinueExecuting() {
        ...
        return !this.creature.getNavigator().noPath() && targetPos != null && !this.creature.world.getFluidState(this.creature.getPosition()).isTagged(FluidTags.LAVA) && !this.creature.world.getFluidState(this.creature.getPosition()).isTagged(FluidTags.WATER);
    }
