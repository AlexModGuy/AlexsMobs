    ...
    public void tick() {
        ...
        if (this.isNoAi()) {
            ...
            if (this.level().isClientSide && this.isInWater() && this.getDeltaMovement().lengthSqr() > 0.03D) {
                ...
                float f = Mth.cos(this.getYRot() * Mth.DEG_TO_RAD) * 0.9F;
                float f1 = Mth.sin(this.getYRot() * Mth.DEG_TO_RAD) * 0.9F;
        ...
        if (attackTarget != null && distanceTo(attackTarget) < attackTarget.getBbWidth() + this.getBbWidth() + 2) {
            ...
            if (this.getAnimation() == ANIMATION_TAILSWING && this.getAnimationTick() == 6) {
                ...
                attackTarget.knockback(1F, Mth.sin(getYRot() * Mth.DEG_TO_RAD), -Mth.cos(getYRot() * Mth.DEG_TO_RAD));
            ...
            if (this.operation == MoveControl.Operation.MOVE_TO && !this.dolphin.getNavigation().isDone()) {
                ...
                if (d3 < (double) 2.5000003E-7F) {
                    ...
                    if (this.dolphin.isInWater()) {
                        ...
                        float f3 = Mth.cos(this.dolphin.getXRot() * Mth.DEG_TO_RAD);
                        float f4 = Mth.sin(this.dolphin.getXRot() * Mth.DEG_TO_RAD);
