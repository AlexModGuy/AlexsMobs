...
public class BoneSerpentAIJump extends JumpGoal {
    ...
    private boolean canJumpTo(BlockPos pos, int dx, int dz, int scale) {
        ...
        return (this.dolphin.world.getFluidState(blockpos).isTagged(FluidTags.WATER) || this.dolphin.world.getFluidState(blockpos).isTagged(FluidTags.LAVA)) && !this.dolphin.world.getBlockState(blockpos).getMaterial().blocksMovement();
    }
