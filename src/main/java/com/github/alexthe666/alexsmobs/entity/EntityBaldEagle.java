...
public class EntityBaldEagle extends TamableAnimal implements IFollower {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(4, new EntityAINearestTarget3D(this, LivingEntity.class, 5, true, true, AMEntityRegistry.buildPredicateFromTag(AMTagRegistry.BALD_EAGLE_TARGETS)) {
            public boolean canUse() {
