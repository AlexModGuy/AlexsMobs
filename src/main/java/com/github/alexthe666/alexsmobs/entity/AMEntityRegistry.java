...
public class AMEntityRegistry {
    ...
    public static final EntityType<EntityCentipedeBody> CENTIPEDE_BODY = registerEntity(EntityType.Builder.of(EntityCentipedeBody::new, MobCategory.CREATURE).sized(0.9F, 0.9F).fireImmune(), "centipede_body");
    public static final EntityType<EntityCentipedeTail> CENTIPEDE_TAIL = registerEntity(EntityType.Builder.of(EntityCentipedeTail::new, MobCategory.CREATURE).sized(0.9F, 0.9F).fireImmune(), "centipede_tail");
    ...
    public static final EntityType<EntityElephant> ELEPHANT = registerEntity(EntityType.Builder.of(EntityElephant::new, MobCategory.CREATURE).sized(2.1F, 2.5F).setUpdateInterval(1), "elephant");
    ...
    public static final EntityType<EntitySnowLeopard> SNOW_LEOPARD = registerEntity(EntityType.Builder.of(EntitySnowLeopard::new, MobCategory.CREATURE).sized(1.2F, 1.3F), "snow_leopard");
    ...
    public static final EntityType<EntityCosmaw> COSMAW = registerEntity(EntityType.Builder.of(EntityCosmaw::new, MobCategory.CREATURE).sized(1.85F, 1.3F), "cosmaw");
