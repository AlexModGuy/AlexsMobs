...
public class AMEntityRegistry {
    ...
    public static final RegistryObject<EntityType<EntityFarseer>> FARSEER = DEF_REG.register("farseer", () -> registerEntity(EntityType.Builder.of(EntityFarseer::new, MobCategory.MONSTER).sized(1F, 1.2F).setShouldReceiveVelocityUpdates(true).setUpdateInterval(1), "farseer"));
