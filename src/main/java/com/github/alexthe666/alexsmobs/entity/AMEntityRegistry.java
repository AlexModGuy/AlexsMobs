...
public class AMEntityRegistry {
    ...
    public static final EntityType<EntitySpectre> SPECTRE = registerEntity(EntityType.Builder.create(EntitySpectre::new, EntityClassification.CREATURE).size(2.75F, 0.75F).immuneToFire().setTrackingRange(10).setShouldReceiveVelocityUpdates(true).setUpdateInterval(1), "spectre");
