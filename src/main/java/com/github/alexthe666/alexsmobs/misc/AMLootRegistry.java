...
public class AMLootRegistry {
    ...
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> ANCIENT_DART = DEF_REG.register("ancient_dart", AncientDartLootModifier::makeCodec);
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> PIGSHOES = DEF_REG.register("pigshoes", PigshoesLootModifier::makeCodec);
}
