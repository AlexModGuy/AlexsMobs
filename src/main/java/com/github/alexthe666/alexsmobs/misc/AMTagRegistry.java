...
public class AMTagRegistry {
    ...
    public static final ResourceLocation ENDERGRADE_SPAWNS = new ResourceLocation("alexsmobs","endergrade_spawns");
    ...
    public static final ResourceLocation MUNGUS_SPAWNS = new ResourceLocation("alexsmobs","mungus_spawns");
