...
public class AMEffectRegistry {
    ...
    public static void onInitItems(){
        ...
        BrewingRecipeRegistry.addRecipe(Ingredient.fromStacks(createPotion(POISON_RESISTANCE_POTION)), Ingredient.fromItems(Items.REDSTONE), createPotion(LONG_POISON_RESISTANCE_POTION));
        BrewingRecipeRegistry.addRecipe(Ingredient.fromStacks(createPotion(Potions.STRONG_SWIFTNESS)), Ingredient.fromItems(AMItemRegistry.GAZELLE_HORN), createPotion(SPEED_III_POTION));
