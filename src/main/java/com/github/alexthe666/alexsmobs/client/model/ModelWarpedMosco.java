...
public class ModelWarpedMosco extends AdvancedEntityModel<EntityWarpedMosco> {
    ...
    public ModelWarpedMosco() {
        ...
        back.setRotationPoint(0.0F, -4.0F, 7.0F);
        body.addChild(back);
        ...
        legfront_left.setRotationPoint(5.5F, 2.0F, -4.5F);
        ...
        kneefront_left.setRotationPoint(0.0F, 10.0F, 0.0F);
        ...
        legfront_right.setRotationPoint(-5.5F, 2.0F, -4.5F);
        ...
        kneefront_right.setRotationPoint(0.0F, 10.0F, 0.0F);
        ...
        legback_left.setRotationPoint(5.5F, 2.0F, 5.5F);
        ...
        kneeback_left.setRotationPoint(0.0F, 10.0F, 0.0F);
        ...
        legback_right.setRotationPoint(-5.5F, 2.0F, 5.5F);
        ...
        kneeback_right.setRotationPoint(0.0F, 10.0F, 0.0F);
        ...
        wingtop_left.setRotationPoint(0.5F, -7.0F, 8.0F);
        ...
        wingtop_right.setRotationPoint(-0.5F, -7.0F, 8.0F);
        ...
        wingbottom_left.setRotationPoint(0.5F, -6.0F, 8.0F);
        chest.addChild(wingbottom_left);
        setRotationAngle(wingbottom_left, 0.0F, -0.0873F, -0.2182F);


        wingbottom_left_r1 = new AdvancedModelBox(this);
        wingbottom_left_r1.setRotationPoint(0.0F, 0.0F, 0.0F);
        ...
        wingbottom_right.setRotationPoint(-0.5F, -6.0F, 8.0F);
        chest.addChild(wingbottom_right);
        setRotationAngle(wingbottom_right, 0.0F, 0.0873F, 0.2182F);


        wingbottom_right_r1 = new AdvancedModelBox(this);
        wingbottom_right_r1.setRotationPoint(0.0F, 0.0F, 0.0F);
        ...
        shoulder_left.setRotationPoint(16.0F, -11.0F, 0.0F);
        ...
        shoulderspikes_left.setRotationPoint(6.5F, -4.0F, 0.0F);
        ...
        arm_left.setRotationPoint(1.1F, 6.0F, 2.0F);
        ...
        hand_left.setRotationPoint(0.0F, 11.0F, 0.0F);
        ...
        shoulder_right.setRotationPoint(-16.0F, -11.0F, 0.0F);
        ...
        shoulderspikes_right.setRotationPoint(-6.5F, -4.0F, 0.0F);
        ...
        arm_right.setRotationPoint(-1.2F, 6.0F, 2.0F);
        ...
        hand_right.setRotationPoint(0.0F, 11.0F, 0.0F);
        ...
        antenna_left.setRotationPoint(2.0F, -5.0F, -5.0F);
        ...
        antenna_right.setRotationPoint(-2.0F, -5.0F, -5.0F);
        ...
        proboscis.setRotationPoint(0.0F, -1.0F, -6.0F);
        head.addChild(proboscis);


        proboscis_r1 = new AdvancedModelBox(this);
        proboscis_r1.setRotationPoint(0.0F, -1.0F, 1.0F);
