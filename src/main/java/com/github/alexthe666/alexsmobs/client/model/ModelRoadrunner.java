...
public class ModelRoadrunner extends AdvancedEntityModel<EntityRoadrunner> {
    ...
    public ModelRoadrunner() {
        ...
        root.setPos(0.0F, 24.0F, -0.5F);
        body = new AdvancedModelBox(this);
        body.setPos(0.0F, -7.5F, 0.0F);
        root.addChild(body);
    ...
    @Override
    public void setupAnim(EntityRoadrunner entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
