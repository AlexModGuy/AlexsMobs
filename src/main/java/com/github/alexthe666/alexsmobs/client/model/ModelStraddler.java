...
public class ModelStraddler extends AdvancedEntityModel<EntityStraddler> {
    ...
    public ModelStraddler() {
        ...
        hair_left.setRotationPoint(-2.5F, -17.0F, 10.0F);
        ...
        horn_right.setRotationPoint(-9.5F, -12.0F, -4.0F);
        ...
        hair_right.setRotationPoint(2.5F, -17.0F, 10.0F);
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.rotate(leg_right, (float) Math.toRadians(5F), 0, 0);
        animator.rotate(leg_left, (float) Math.toRadians(5F), 0, 0);
        animator.rotate(horn_right, 0, 0, (float) Math.toRadians(-10F));
        animator.rotate(horn_left, 0, 0, (float) Math.toRadians(10F));
        animator.rotate(hair_left, 0, (float) Math.toRadians(-70F), 0);
        animator.rotate(hair_right, 0, (float) Math.toRadians(70F), 0);
        ...
        animator.rotate(leg_right, (float) Math.toRadians(5F), 0, 0);
        animator.rotate(leg_left, (float) Math.toRadians(5F), 0, 0);
        animator.rotate(horn_right, (float) Math.toRadians(-30F), 0, (float) Math.toRadians(-10F));
        animator.rotate(horn_left, (float) Math.toRadians(-30F), 0, (float) Math.toRadians(10F));
        animator.rotate(hair_left, (float) Math.toRadians(20F), (float) Math.toRadians(-15F), 0);
        animator.rotate(hair_right, (float) Math.toRadians(20F), (float) Math.toRadians(15F), 0);
        animator.endKeyframe();
        animator.startKeyframe(5);
        animator.rotate(body, (float) Math.toRadians(25F), 0, 0);
        animator.rotate(leg_right, (float) Math.toRadians(-25F), 0, 0);
        animator.rotate(leg_left, (float) Math.toRadians(-25F), 0, 0);
        animator.rotate(horn_right, (float) Math.toRadians(20F), 0, (float) Math.toRadians(0F));
        animator.rotate(horn_left, (float) Math.toRadians(20F), 0, (float) Math.toRadians(0F));
        animator.rotate(hair_left, (float) Math.toRadians(20F), (float) Math.toRadians(-160F), 0);
        animator.rotate(hair_right, (float) Math.toRadians(20F), (float) Math.toRadians(160F), 0);
    ...
    @Override
    public void setRotationAngles(EntityStraddler entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
