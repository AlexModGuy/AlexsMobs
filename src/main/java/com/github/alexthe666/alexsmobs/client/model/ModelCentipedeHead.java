...
public class ModelCentipedeHead extends AdvancedEntityModel<EntityCentipedeHead> {
	...
	public ModelCentipedeHead() {
		...
		head.setRotationPoint(0.0F, -7.875F, 0.375F);
		bone.addChild(head);
	...
	@Override
	public void setRotationAngles(EntityCentipedeHead entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
