...
public class ModelHummingbird extends AdvancedEntityModel<EntityHummingbird> {
    ...
    public ModelHummingbird() {
        ...
        wingL.setRotationPoint(1.5F, -4.5F, 0.5F);
        body.addChild(wingL);


        wingL_r1 = new AdvancedModelBox(this);
        wingL_r1.setRotationPoint(-0.3F, 0.0F, -1.0F);
        ...
        wingR.setRotationPoint(-1.5F, -4.5F, 0.5F);
        body.addChild(wingR);


        wingR_r1 = new AdvancedModelBox(this);
        wingR_r1.setRotationPoint(0.3F, 0.0F, -1.0F);
        ...
        tail.setRotationPoint(0.0F, -0.1F, 1.5F);
        body.addChild(tail);
        ...
        legL.setRotationPoint(0.9F, -0.7F, -1.1F);
        body.addChild(legL);
        ...
        legR.setRotationPoint(-0.9F, -0.7F, -1.1F);
        body.addChild(legR);
    ...
    @Override
    public void setRotationAngles(EntityHummingbird entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
