...
public class ModelAnteater extends AdvancedEntityModel<EntityAnteater> {
    ...
    public void animate(EntityAnteater entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.rotate(tail, (float)Math.toRadians(25), (float)Math.toRadians(15), 0);
        ...
        animator.rotate(left_arm, (float)Math.toRadians(-50), 0, (float)Math.toRadians(-45));
        animator.endKeyframe();
        animator.startKeyframe(2);
        animator.rotate(head, (float)Math.toRadians(5), 0, 0);
        animator.move(left_arm, 0, 2, 0);
        animator.rotate(left_arm, (float)Math.toRadians(-10) + (float)Math.toRadians(-70) * inverStandProgress, 0, (float)Math.toRadians(65) * standProgress);
        animator.endKeyframe();
        ...
        animator.rotate(right_leg, (float)Math.toRadians(15), 0, 0);
        animator.rotate(left_leg, (float)Math.toRadians(15), 0, 0);
        animator.rotate(right_arm, (float)Math.toRadians(-50), 0, (float)Math.toRadians(45));
        animator.endKeyframe();
        animator.startKeyframe(2);
        animator.rotate(head, (float)Math.toRadians(5), 0, 0);
        animator.move(right_arm, 0, 2, 0);
        animator.rotate(right_arm, (float)Math.toRadians(-10) + (float)Math.toRadians(-70) * inverStandProgress, 0, (float)Math.toRadians(-65) * standProgress);
        animator.endKeyframe();
        animator.resetKeyframe(5);
    ...
    public void setupAnim(EntityAnteater entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        ...
        progressRotationPrev(body, standProgress, (float)Math.toRadians(-80), 0, 0, 5F);
        progressRotationPrev(left_leg, standProgress, (float)Math.toRadians(80), (float)Math.toRadians(10), 0, 5F);
        progressRotationPrev(right_leg, standProgress, (float)Math.toRadians(80), (float)Math.toRadians(-10), 0, 5F);
        progressRotationPrev(tail, standProgress, (float)Math.toRadians(80), 0, 0, 5F);
        progressRotationPrev(left_arm, standProgress, (float)Math.toRadians(45), (float)Math.toRadians(-70), (float)Math.toRadians(-120), 5F);
        progressRotationPrev(right_arm, standProgress, (float)Math.toRadians(45), (float)Math.toRadians(70), (float)Math.toRadians(120), 5F);
        progressRotationPrev(head, standProgress, (float)Math.toRadians(80), 0, 0, 5F);
        ...
        if(entity.isBaby() && entity.isPassenger()){
            progressRotationPrev(left_arm, 1, 0,  (float)Math.toRadians(-90), (float)Math.toRadians(-60), 1);
            progressRotationPrev(right_arm, 1, 0,  (float)Math.toRadians(90), (float)Math.toRadians(60), 1);
            progressRotationPrev(left_leg, 1, (float)Math.toRadians(20), 0, (float)Math.toRadians(-60), 1);
            progressRotationPrev(right_leg, 1, (float)Math.toRadians(20), 0, (float)Math.toRadians(60), 1);
            progressRotationPrev(tail, 1, (float)Math.toRadians(-20), 0, 0, 1);
        }
        progressRotationPrev(head, leaningProgress, (float)Math.toRadians(50), 0, 0, 20F);
