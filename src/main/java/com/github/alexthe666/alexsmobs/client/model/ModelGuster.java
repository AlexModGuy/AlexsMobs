...
public class ModelGuster extends AdvancedEntityModel<EntityGuster> {
    ...
    public ModelGuster() {
        ...
        tornado.setRotationPoint(0.0F, -4.0F, 0.0F);
        ...
        tornado2.setRotationPoint(0.0F, -8.0F, 0.0F);
        ...
        tornadomid.setRotationPoint(0.0F, 6.0F, 0.0F);
        ...
        tornado3.setRotationPoint(0.0F, -8.0F, 0.0F);
        ...
        tornado4.setRotationPoint(0.0F, -8.0F, 0.0F);
        ...
        eyes.setRotationPoint(0.0F, -18.0F, -15.0F);
        root.addChild(eyes);


        eye_left = new AdvancedModelBox(this);
        eye_left.setRotationPoint(4.0F, 0.0F, 0.0F);
        ...
        eye_right.setRotationPoint(-4.0F, 0.0F, 0.0F);
    ...
    @Override
    public void setRotationAngles(EntityGuster entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
