...
public class ModelCaiman extends AdvancedEntityModel<EntityCaiman> {
    ...
    public void setupAnim(EntityCaiman entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        progressRotationPrev(rightArm, swimProgress, (float) Math.toRadians(75), 0, (float) Math.toRadians(60), 1F);
        progressRotationPrev(leftArm, swimProgress, (float) Math.toRadians(75), 0, (float) Math.toRadians(-60), 1F);
        progressRotationPrev(rightLeg, swimProgress, (float) Math.toRadians(75), 0, (float) Math.toRadians(60), 1F);
        progressRotationPrev(leftLeg, swimProgress, (float) Math.toRadians(75), 0, (float) Math.toRadians(-60), 1F);
        ...
        progressRotationPrev(topJaw, grabProgress, (float) Math.toRadians(-15), 0, 0, 5F);
        progressRotationPrev(bottomJaw, grabProgress, (float) Math.toRadians(25), 0, 0, 5F);
        progressRotationPrev(head, sitProgress, (float) Math.toRadians(10), (float) Math.toRadians(-20), 0, 5F);
        progressRotationPrev(body, sitProgress, 0, (float) Math.toRadians(10), 0, 5F);
        progressPositionPrev(tail1, sitProgress, -1, 0, -1, 5F);
        progressRotationPrev(tail1, sitProgress, 0, (float) Math.toRadians(40), 0, 5F);
        progressRotationPrev(tail2, sitProgress, 0, (float) Math.toRadians(40), 0, 5F);
        progressRotationPrev(tail3, sitProgress, 0, (float) Math.toRadians(50), 0, 5F);
