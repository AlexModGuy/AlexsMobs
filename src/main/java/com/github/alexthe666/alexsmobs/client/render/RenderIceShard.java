...
public class RenderIceShard extends EntityRenderer<EntityIceShard> {
    private static final ResourceLocation TEXTURE = ResourceLocation.parse("alexsmobs:textures/entity/ice_shard.png");

    public RenderIceShard(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn);
    }

    public void render(EntityIceShard p_225623_1_, float p_225623_2_, float p_225623_3_, PoseStack p_225623_4_,
    ...
    public void drawVertex(Matrix4f p_229039_1_, Matrix3f p_229039_2_, VertexConsumer p_229039_3_, int p_229039_4_,
        ...
        p_229039_3_.addVertex(pos.x, pos.y, pos.z).setColor(255, 255, 255, 255).setUv(p_229039_7_, p_229039_8_)
                .setOverlay(OverlayTexture.NO_OVERLAY).setLight(p_229039_12_).setNormal(normal.x, normal.y, normal.z);
    }
