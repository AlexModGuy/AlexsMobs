...
public class RenderMudskipper extends MobRenderer<EntityMudskipper, ModelMudskipper> {
    private static final ResourceLocation TEXTURE = ResourceLocation.parse("alexsmobs:textures/entity/mudskipper.png");
    private static final ResourceLocation TEXTURE_SPIT = ResourceLocation.parse("alexsmobs:textures/entity/mudskipper_spit.png");
