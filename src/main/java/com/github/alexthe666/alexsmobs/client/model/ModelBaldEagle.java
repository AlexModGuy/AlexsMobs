...
public class ModelBaldEagle extends AdvancedEntityModel<EntityBaldEagle> {
    ...
    public ModelBaldEagle() {
        ...
        body.setRotationPoint(0.0F, -9.3F, -2.0F);
        root.addChild(body);
        ...
        legL.setRotationPoint(-1.4F, 5.5F, -1.15F);
        body.addChild(legL);
        ...
        footL.setRotationPoint(0.0F, 4.2F, 0.5F);
        legL.addChild(footL);
        ...
        legR.setRotationPoint(1.4F, 5.5F, -1.15F);
        body.addChild(legR);
        ...
        footR.setRotationPoint(0.0F, 4.2F, 0.5F);
        legR.addChild(footR);
        ...
        tail.setRotationPoint(0.0F, 8.07F, 1.36F);
        body.addChild(tail);
        ...
        headPivot.setRotationPoint(0.0F, -0.51F, 0.64F);
        ...
        topHead.setRotationPoint(0.0F, -4.9F, -0.5F);
        ...
        beak1.setRotationPoint(0.0F, -3.5F, -0.7F);
        head.addChild(beak1);
        ...
        beak2.setRotationPoint(0.0F, -1.0F, -2.54F);
        ...
        hood_tie.setRotationPoint(0.0F, -3.65F, 1.85F);
        ...
        hood.setRotationPoint(0.0F, -4.9F, -0.5F);
        head.addChild(hood);
        ...
        wingR.setRotationPoint(-1.9F, 0.0F, 2.0F);
        body.addChild(wingR);
        ...
        feathersR.setRotationPoint(-0.5F, 0.8F, 1.6F);
        ...
        tipR.setRotationPoint(-0.51F, 11.8F, 0.5F);
        wingR.addChild(tipR);
        ...
        wingL.setRotationPoint(1.9F, 0.0F, 2.0F);
        body.addChild(wingL);
        ...
        feathersL.setRotationPoint(0.5F, 0.8F, 1.6F);
        ...
        tipL.setRotationPoint(0.51F, 11.8F, 0.5F);
        wingL.addChild(tipL);
    ...
    public void setRotationAngles(EntityBaldEagle entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        ...
        progressRotationPrev(body, flyProgress, (float) Math.toRadians(40), 0, 0, 5F);
        progressRotationPrev(tail, flyProgress, (float) Math.toRadians(-20), 0, 0, 5F);
        progressRotationPrev(legL, flyFeetProgress, (float) Math.toRadians(30), 0, 0, 5F);
        progressRotationPrev(legR, flyFeetProgress, (float) Math.toRadians(30), 0, 0, 5F);
        progressRotationPrev(footL, flyFeetProgress, (float) Math.toRadians(30), 0, 0, 5F);
        progressRotationPrev(footR, flyFeetProgress, (float) Math.toRadians(30), 0, 0, 5F);
        progressPositionPrev(legL, flyFeetProgress, 0, -1, 0, 5f);
        progressPositionPrev(legR, flyFeetProgress, 0, -1, 0, 5f);
        progressRotationPrev(wingR, flyProgress,  (float) Math.toRadians(-120),  (float) Math.toRadians(90),  0, 5F);
        progressPositionPrev(wingR, flyProgress, -1, 5, 0F, 5f);
        progressRotationPrev(wingL, flyProgress,  (float) Math.toRadians(-120),  (float) Math.toRadians(-90),  0, 5F);
        ...
        progressRotationPrev(body, perchProgress, (float) Math.toRadians(-20), 0, 0, 5F);
        progressRotationPrev(legL, perchProgress, (float) Math.toRadians(20), 0, 0, 5F);
        progressRotationPrev(legR, perchProgress, (float) Math.toRadians(20), 0, 0, 5F);
        progressRotationPrev(tail, perchProgress, (float) Math.toRadians(10), 0, 0, 5F);
        progressPositionPrev(body, perchProgress, 0, -1, 0, 5f);
        progressRotationPrev(body, tackleProgress, (float) Math.toRadians(-20), 0, 0, 5F);
        progressPositionPrev(body, tackleProgress, 0, -1, 0, 5f);
        progressRotationPrev(legL, tackleProgress, (float) Math.toRadians(-60), 0, 0, 5F);
        progressRotationPrev(legR, tackleProgress, (float) Math.toRadians(-60), 0, 0, 5F);
        progressPositionPrev(legL, tackleProgress, 0, -1, 1, 5f);
        progressPositionPrev(legR, tackleProgress, 0, -1, 1, 5f);
        progressRotationPrev(wingL, swoopProgress,  (float) Math.toRadians(60),  (float) Math.toRadians(50),  0, 5F);
        progressPositionPrev(wingL, swoopProgress, -2, -2, 0, 5f);
        progressRotationPrev(wingR, swoopProgress,  (float) Math.toRadians(60),  (float) Math.toRadians(-50),  0, 5F);
        progressPositionPrev(wingR, swoopProgress, 2, -2, 0, 5f);
        progressRotationPrev(head, swoopProgress, (float) Math.toRadians(-10), 0, 0, 5F);
        progressRotationPrev(head, biteProgress, (float)Math.toRadians(70), 0, 0, 2.5F);
        if(flyProgress > 0){
            ...
            progressRotationPrev(body, walk, (float) Math.toRadians(15), 0, 0, 1);
            progressRotationPrev(legL, walk, (float) Math.toRadians(-15), 0, 0, 1);
            progressRotationPrev(legR, walk, (float) Math.toRadians(-15), 0, 0, 1);
            progressRotationPrev(wingL, walk, (float) Math.toRadians(-15), 0, 0, 1);
            progressRotationPrev(wingR, walk, (float) Math.toRadians(-15), 0, 0, 1);
