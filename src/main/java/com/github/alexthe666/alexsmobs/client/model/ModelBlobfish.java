...
public class ModelBlobfish extends AdvancedEntityModel<EntityBlobfish> {
    ...
    public ModelBlobfish() {
        ...
        root.addChild(body);
        body.texOffs(0, 0).addBox(-3.0F, -2.5F, -8.0F, 6.0F, 5.0F, 8.0F, 0.0F, false);

        nose = new AdvancedModelBox(this);
        nose.setPos(0.0F, -0.5F, -8.0F);
        body.addChild(nose);
        nose.texOffs(0, 19).addBox(-2.0F, -1.0F, -1.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);

        tail = new AdvancedModelBox(this);
        tail.setPos(0.0F, 0.25F, 0.0F);
        body.addChild(tail);
        tail.texOffs(11, 14).addBox(-2.0F, -2.25F, 0.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);

        tail_fin = new AdvancedModelBox(this);
        tail_fin.setPos(0.0F, -1.45F, 0.0F);
        tail.addChild(tail_fin);
        tail_fin.texOffs(0, 14).addBox(0.0F, -2.0F, -1.0F, 0.0F, 6.0F, 10.0F, 0.0F, false);
        ...
        fin_left.texOffs(0, 0).addBox(0.0F, -1.5F, 0.0F, 3.0F, 3.0F, 0.0F, 0.0F, false);
        ...
        fin_right.texOffs(0, 0).addBox(-3.0F, -1.5F, 0.0F, 3.0F, 3.0F, 0.0F, 0.0F, true);
