...
public class ModelGiantSquid extends AdvancedEntityModel<EntityGiantSquid> {
    ...
    public void setupAnim(EntityGiantSquid entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        progressRotationPrev(mantle_end, dryProgress, (float) Math.toRadians(-10), 0, 0, 5F);
        progressRotationPrev(right_membrane, dryProgress, 0, (float) Math.toRadians(20), 0, 5F);
        progressRotationPrev(left_membrane, dryProgress, 0, (float) Math.toRadians(-20), 0, 5F);
        progressRotationPrev(mantle, dryProgress, 0, 0, (float) Math.toRadians(15), 5F);
        progressRotationPrev(left_FrontTentacle, dryProgress, (float) Math.toRadians(10), 0, (float) Math.toRadians(-25), 5F);
        progressRotationPrev(left_FrontTentacleEnd, dryProgress, (float) Math.toRadians(5), 0, (float) Math.toRadians(-15), 5F);
        progressRotationPrev(right_FrontTentacle, dryProgress, (float) Math.toRadians(10), 0, (float) Math.toRadians(15), 5F);
        progressRotationPrev(right_tentacleEnd, dryProgress, (float) Math.toRadians(5), 0, (float) Math.toRadians(15), 5F);
        progressRotationPrev(left_BackTentacle, dryProgress, 0, 0, (float) Math.toRadians(-15), 5F);
        progressRotationPrev(left_BackTentacleEnd, dryProgress, 0, 0, (float) Math.toRadians(-15), 5F);
        progressRotationPrev(right_BackTentacle, dryProgress, 0, 0, (float) Math.toRadians(20), 5F);
        progressRotationPrev(right_BackTentacleEnd, dryProgress, 0, 0, (float) Math.toRadians(25), 5F);
        progressRotationPrev(right_BackMidTentacle, dryProgress, (float) Math.toRadians(20), 0, (float) Math.toRadians(20), 5F);
        progressRotationPrev(left_BackMidTentacle, dryProgress, (float) Math.toRadians(15), 0, (float) Math.toRadians(-50), 5F);
        progressRotationPrev(left_FrontMidTentacle, dryProgress, (float) Math.toRadians(35), (float) Math.toRadians(15), (float) Math.toRadians(-50), 5F);
        progressRotationPrev(left_FrontMidTentacleEnd, dryProgress, (float) Math.toRadians(35), (float) Math.toRadians(-15), 0, 5F);
        progressRotationPrev(right_FrontMidTentacle, dryProgress, (float) Math.toRadians(35), (float) Math.toRadians(-15), (float) Math.toRadians(50), 5F);
        progressRotationPrev(right_FrontMidTentacleEnd, dryProgress, (float) Math.toRadians(35), (float) Math.toRadians(15), 0, 5F);
        progressRotationPrev(left_arm, dryProgress, (float) Math.toRadians(10), (float) Math.toRadians(90), 0, 5F);
        progressRotationPrev(left_arm2, dryProgress, (float) Math.toRadians(-10), 0, (float) Math.toRadians(2), 5F);
        progressRotationPrev(left_arm3, dryProgress, 0, 0, (float) Math.toRadians(-20), 5F);
        progressRotationPrev(left_arm4, dryProgress, 0, 0, (float) Math.toRadians(-8), 5F);
        progressRotationPrev(right_arm, dryProgress, (float) Math.toRadians(10), (float) Math.toRadians(-90), 0, 5F);
        progressRotationPrev(right_arm2, dryProgress, (float) Math.toRadians(-10), 0, (float) Math.toRadians(-4), 5F);
        progressRotationPrev(right_arm3, dryProgress, 0, 0, (float) Math.toRadians(-12), 5F);
        progressRotationPrev(right_arm4, dryProgress, 0, 0, (float) Math.toRadians(20), 5F);
        progressRotationPrev(left_arm, grabProgress, (float) Math.toRadians(-110), 0, 0, 5F);
        progressRotationPrev(right_arm, grabProgress, (float) Math.toRadians(-110), 0, 0, 5F);
        progressRotationPrev(left_arm2, grabProgress, (float) Math.toRadians(40), 0, 0, 5F);
        progressRotationPrev(right_arm2, grabProgress, (float) Math.toRadians(40), 0, 0, 5F);
        progressRotationPrev(left_arm3, grabProgress, (float) Math.toRadians(100), 0, 0, 5F);
        progressRotationPrev(right_arm3, grabProgress, (float) Math.toRadians(100), 0, 0, 5F);
        progressRotationPrev(left_arm4, grabProgress, (float) Math.toRadians(70), 0, 0, 5F);
        progressRotationPrev(right_arm4, grabProgress, (float) Math.toRadians(70), 0, 0, 5F);
        progressRotationPrev(left_hand, grabProgress, (float) Math.toRadians(-120), 0, 0, 5F);
        progressRotationPrev(right_hand, grabProgress, (float) Math.toRadians(-120), 0, 0, 5F);
        ...
        progressRotationPrev(left_FrontTentacle, Math.max(grabProgress, capturedProgress), (float) Math.toRadians(-20), (float) Math.toRadians(-20), 0, 5F);
        progressRotationPrev(right_FrontTentacle, Math.max(grabProgress, capturedProgress), (float) Math.toRadians(-20), (float) Math.toRadians(20), 0, 5F);
        progressRotationPrev(left_BackTentacle, Math.max(grabProgress, capturedProgress), (float) Math.toRadians(-20), (float) Math.toRadians(20), 0, 5F);
        progressRotationPrev(right_BackTentacle, Math.max(grabProgress, capturedProgress), (float) Math.toRadians(-20), (float) Math.toRadians(-20), 0, 5F);
        progressRotationPrev(left_FrontMidTentacle, Math.max(grabProgress, capturedProgress), (float) Math.toRadians(-20), (float) Math.toRadians(20), 0, 5F);
        progressRotationPrev(right_FrontMidTentacle, Math.max(grabProgress, capturedProgress), (float) Math.toRadians(-20), (float) Math.toRadians(-20), 0, 5F);
        progressRotationPrev(left_BackMidTentacle, Math.max(grabProgress, capturedProgress), (float) Math.toRadians(-20), (float) Math.toRadians(-20), 0, 5F);
        progressRotationPrev(right_BackMidTentacle, Math.max(grabProgress, capturedProgress), (float) Math.toRadians(-20), (float) Math.toRadians(20), 0, 5F);
        progressRotationPrev(mantle, capturedProgress, (float) Math.toRadians(-20), 0, 0, 5F);
        progressPositionPrev(mantle, capturedProgress, 0, -2, 0, 5F);
        progressRotationPrev(head, capturedProgress, (float) Math.toRadians(20), 0, 0, 5F);
