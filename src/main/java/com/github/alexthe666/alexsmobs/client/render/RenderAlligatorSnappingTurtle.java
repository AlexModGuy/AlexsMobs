...
public class RenderAlligatorSnappingTurtle
    ...
    private static final ResourceLocation TEXTURE_MOSS = ResourceLocation
    ...
    protected void scale(EntityAlligatorSnappingTurtle entitylivingbaseIn, PoseStack matrixStackIn,
    ...
    static class AlligatorSnappingTurtleMossLayer
        ...
        public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn,
                EntityAlligatorSnappingTurtle entitylivingbaseIn, float limbSwing, float limbSwingAmount,
            ...
            if (entitylivingbaseIn.getMoss() > 0) {
                ...
                this.getParentModel().renderToBuffer(matrixStackIn, mossbuffer, packedLightIn,
                        LivingEntityRenderer.getOverlayCoords(entitylivingbaseIn, 0),
                        AMColorUtil.packColor(1.0F, 1.0F, 1.0F, Math.min(1.0F, mossAlpha)));
            }
        }
    }
}
