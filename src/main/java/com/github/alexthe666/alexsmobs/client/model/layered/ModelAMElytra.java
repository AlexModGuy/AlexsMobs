...
public class ModelAMElytra extends HumanoidModel {
    ...
    public ModelAMElytra withAnimations(LivingEntity entity){
        ...
        final float limbSwingAmount = entity.animationSpeedOld + (entity.animationSpeed - entity.animationSpeedOld) * partialTick;
        final float limbSwing = entity.animationPosition + partialTick;
