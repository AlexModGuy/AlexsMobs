...
import com.github.alexthe666.alexsmobs.misc.DragonsBreathDispenserBehavior;
...
public class AMItemRegistry {
    ...
    public static final RegistryObject<Item> END_PIRATE_RIGGING = DEF_REG.register("end_pirate_rigging", () -> new ItemEndPirateRigging(new Item.Properties()));
    ...
    public static void initDispenser(){
        ...
        DispenserBlock.registerBehavior(Items.DRAGON_BREATH, new DragonsBreathDispenserBehavior(new DefaultDispenseItemBehavior()));
