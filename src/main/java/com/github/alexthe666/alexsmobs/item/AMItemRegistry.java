...
public class AMItemRegistry {
    ...
    public static final Item MYSTERIOUS_WORM = new Item(new Item.Properties().group(AlexsMobs.TAB).rarity(Rarity.RARE)).setRegistryName("alexsmobs:mysterious_worm");
