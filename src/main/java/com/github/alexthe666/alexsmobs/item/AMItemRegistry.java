...
public class AMItemRegistry {
    ...
    public static final Item CROCODILE_TOOTH = new Item(new Item.Properties().group(AlexsMobs.TAB)).setRegistryName("alexsmobs:crocodile_tooth");
    ...
    public static final Item ANCIENT_DART = new Item(new Item.Properties().group(AlexsMobs.TAB).maxStackSize(1).rarity(Rarity.UNCOMMON)).setRegistryName("alexsmobs:ancient_dart");
    ...
    public static final Item KANGAROO_MEAT = new Item(new Item.Properties().group(AlexsMobs.TAB).food(new Food.Builder().hunger(4).saturation(0.6F).meat().build())).setRegistryName("alexsmobs:kangaroo_meat");
    ...
    public static final Item MYSTERIOUS_WORM = new Item(AlexsMobs.PROXY.setupISTER(new Item.Properties().group(AlexsMobs.TAB).rarity(Rarity.RARE))).setRegistryName("alexsmobs:mysterious_worm");
    ...
    public static void registerItem(RegistryEvent.Register<Item> event) {
        ...
        event.getRegistry().register(new SpawnEggItem(AMEntityRegistry.VOID_WORM, 0X0F1026,0X1699AB, new Item.Properties().group(AlexsMobs.TAB)).setRegistryName("alexsmobs:spawn_egg_void_worm"));
        event.getRegistry().register(new SpawnEggItem(AMEntityRegistry.FRILLED_SHARK, 0X726B6B,0X873D3D, new Item.Properties().group(AlexsMobs.TAB)).setRegistryName("alexsmobs:spawn_egg_frilled_shark"));
        event.getRegistry().register(new SpawnEggItem(AMEntityRegistry.MIMIC_OCTOPUS, 0XFFEBDC,0X1D1C1F, new Item.Properties().group(AlexsMobs.TAB)).setRegistryName("alexsmobs:spawn_egg_mimic_octopus"));
        event.getRegistry().register(new SpawnEggItem(AMEntityRegistry.SEAGULL, 0XC9D2DC,0XFFD850, new Item.Properties().group(AlexsMobs.TAB)).setRegistryName("alexsmobs:spawn_egg_seagull"));
        try {
        ...
        DispenserBlock.registerDispenseBehavior(ANCIENT_DART, new ProjectileDispenseBehavior() {
            protected ProjectileEntity getProjectileEntity(World worldIn, IPosition position, ItemStack stackIn) {
