...
public class BlockTriopsEggs extends FrogspawnBlock {
    public BlockTriopsEggs() {
        super(BlockBehaviour.Properties.of(Material.EGG, MaterialColor.COLOR_ORANGE).instabreak().noOcclusion().noCollission().sound(SoundType.FROGSPAWN).offsetType(OffsetType.XZ));
    }
